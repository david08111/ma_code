...
def panoptic_converter(original_format_folder, out_folder, out_file):
    ...
    file_list = sorted(glob.glob(os.path.join(original_format_folder, '*/*_instanceIds.png')))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--destination_path", type=str,
                        help="Filepath to destination of converted data")
    parser.add_argument("-f", "--out_file_path", type=str,
                        help="File path for dataset file")
    args = parser.parse_args()

    panoptic_converter(args.source_path, args.destination_path, args.out_file_path)