...
def predict_and_eval(visualize, dataset_cfg_path, out_path, weight_file, config_path, copy, min_samples, min_cluster_size, cluster_selection_epsilon):
    ...
    config_dict["model"]["output_creation"][0]["nearest_class_mean_association"]["instance_clustering_method"] = {"optics": {}}

    #####################################
    ##########
    if min_samples:
        config_dict["model"]["output_creation"][0]["nearest_class_mean_association"]["instance_clustering_method"]["optics"]["min_samples"] = min_samples
    if min_cluster_size:
        config_dict["model"]["output_creation"][0]["nearest_class_mean_association"]["instance_clustering_method"][
            "optics"]["min_cluster_size"] = min_cluster_size
    if cluster_selection_epsilon:
        config_dict["model"]["output_creation"][0]["nearest_class_mean_association"]["instance_clustering_method"][
            "optics"]["eps"] = cluster_selection_epsilon
...
if __name__ == "__main__":
    ...
    min_samples_def = 150
    min_cluster_size_def = 50
    cluster_selection_epsilon_def = None


    min_samples_list = [5, 10, 25, 50, 100, 150, 300, 750, 1500, 5000, 10000, 25000, 50000, 100000]

    min_cluster_size_list = [5, 10, 25, 50, 100, 150, 300, 750, 1500, 5000, 10000, 25000, 50000, 100000]

    cluster_selection_epsilon_list = [5, 10, 25, 50, 100, 150, 300, 750, 1500, 5000, 10000, 25000, 50000, 100000]
